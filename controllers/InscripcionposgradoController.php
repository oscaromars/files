...
class InscripcionposgradoController extends \yii\web\Controller {
    ...
    public function actionIndex() {
        ...
        $arr_prov_emp = Provincia::provinciaXPais($arr_pais_emp[0]["id"]);
        ...
        $arr_pais_emp = Pais::find()->select("pai_id AS id, pai_nombre AS value")->where(["pai_estado_logico" => "1", "pai_estado" => "1"])->asArray()->all();
