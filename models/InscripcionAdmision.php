...
use app\models\PersonaOtrosDatos;
            ...
            if ($resp_datos) {
                ...
                if (isset($identificacion) && strlen($identificacion) > 0) {
                    ...
                    if ($id_persona > 0) {
                        ...
                        if (empty($existe)) {
                            $respPerOtros = $mod_PersonaOtro->insertar($datos);
                        }                        
                        if ($respPerOtros > 0) {
                        //self::movePersonFiles($twinIds,$id_persona);
                            $concap = \Yii::$app->db_captacion;
                                                    ...
                                                    if ($resp_opago) {
                                                        ...
                                                        if ($resp_dpago) {
                                                            ...
                                                            if (($fpag_id == 5) or ($fpag_id == 4)) { 
                                                                ...
                                                                $rpag_imagen = null;
                                                                $resp_rpagos = $mod_ordenpago->insertarRegistropago($resp_dpago, $fpag_id, $val_total, $fecha_ini, $rpag_imagen, $null, $fecha_ini, $null, "AP", $usuario_id, "RE");
                                                                if ($resp_rpagos) {
                                                                    $detalle = 'S';
                                                                }                                                                
                                                            }
