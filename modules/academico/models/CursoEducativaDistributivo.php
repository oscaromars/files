...
class CursoEducativaDistributivo extends \yii\db\ActiveRecord {
	...
	public function getListadoDistributivoedu($search = NULL, $modalidad = NULL, $asignatura = NULL, $jornada = NULL, $unidadAcademico = NULL, $periodoAcademico = NULL, $onlyData = false, $reporte = NULL) {
		...
		$sql = "SELECT
                ...
                FROM
                    ...
                    LEFT JOIN " . $con_academico->dbname . ".curso_educativa_distributivo cedi on da.daca_id=cedi.daca_id
                WHERE
                    $str_search
                    $str_modalidad
                    $str_asignatura
	 ...
	 * Modificación campo MPP, de acuerdo, a la actualización
	 * @author  Giovanni Vergara <analistadesarrollo02@uteg.edu.ec>;
	 * @modify  Luis Cajamarca <analistadesarrollo04>
	 * @property
	 * @return
	 */
	public function consultarDistribuAca($paca_id, $asi_id, $mpp_id, $pro_id, $uaca_id, $mod_id) {
		$con = \Yii::$app->db_academico;
		$estado = 1;
