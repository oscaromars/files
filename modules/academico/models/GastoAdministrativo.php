...
class GastoAdministrativo extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['uaca_id', 'mod_id', 'gadm_bloque', 'gadm_fecha_inicio', 'gadm_usuario_creacion', 'gadm_estado', 'gadm_estado_logico'], 'required'],
            [['uaca_id', 'mod_id', 'gadm_usuario_creacion', 'gadm_usuario_modificacion'], 'integer'],
