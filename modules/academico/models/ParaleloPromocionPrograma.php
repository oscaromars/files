...
class ParaleloPromocionPrograma extends \yii\db\ActiveRecord {
	...
	public function getParalelosprograma($maca_id) {
		...
		$sql = "SELECT pppr.pppr_id as id,
                ...
                INNER JOIN " . $con->dbname . ".malla_unidad_modalidad mumo on meun.meun_id = mumo.meun_id
                WHERE mumo.maca_id = :maca_id AND
                      ppro.ppro_estado = :estado AND ppro.ppro_estado_logico = :estado AND
