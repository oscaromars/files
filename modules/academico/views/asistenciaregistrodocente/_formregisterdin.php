...
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
     ...
     <div class="form-group"> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                <?= Html::dropDownList("cmb_modalidad", 1,$arr_modalidad, ["class" => "form-control", "id" => "cmb_modalidad","disabled" => "True"]) ?>
        </div>
    </div>
</div>
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
    <div class="form-group"> 
        <label for="cmb_profesor_asis" class="col-xs-12 col-sm-12 col-md-5 col-lg-5 control-label"><?= academico::t("Academico", "Teacher") ?></label>
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                <?= Html::dropDownList("cmb_profesor_asis", 0,$arr_profesor_all, ["class" => "form-control", "id" => "cmb_profesor_asis"]) ?>
        </div>
    </div>
</div>
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">                
        <a id="btn_buscarDataregistrodin" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Search") ?></a>
    </div>
</div>
</div>
