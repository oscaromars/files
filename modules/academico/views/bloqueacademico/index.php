		...
		['class' => 'yii\grid\ActionColumn',
			...
			'buttons' => [
				'delete' => function ($url, $model) {
					if (!empty($model['id'])) {
						return Html::a('<span class="' . Utilities::getIcon('remove') . '"></span>', null, ['href' => 'javascript:confirmDelete(\'eliminarbloque\',[\'' . $model['id'] . '\']);', "data-toggle" => "tooltip", "title" => Yii::t("accion", "Delete")]);
					} else {
