...
<div class="row">
    <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12"><br><br>
        <div class="form-group">                 
            ...
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">  
                    <?= Html::dropDownList("cmb_periodo_aul",1,$arr_periodos, ["class" => "form-control", "id" => "cmb_periodo_aul"]) ?>              
            </div>
            ...
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                    <?= Html::dropDownList("cmb_unidad_aul", 0, $arr_unidad, ["class" => "form-control", "id" => "cmb_unidad_aul"]) ?>
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group"> 
            ...
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                    <?= Html::dropDownList("cmb_modalidad_aul", 0,$arr_modalidad, ["class" => "form-control", "id" => "cmb_modalidad_aul"]) ?>
            </div>
 ...
 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group"> 
            ...
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                    <?= Html::dropDownList("cmb_parcial_aul", 0,$arr_parcial, ["class" => "form-control", "id" => "cmb_parcial_aul"]) ?>
            </div>
            <!-- <label for="cmb_aulas_aul" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= academico::t("Academico", "Course") ?></label>
            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3">
                    <?= Html::dropDownList("cmb_aulas_aul", 0,$arr_aula, ["class" => "form-control", "id" => "cmb_aulas_aul"]) ?>
