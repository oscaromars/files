...
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                <?=Html::dropDownList("cmb_unidad_rc", 0, $arr_ninteres, ["class" => "form-control", "id" => "cmb_unidad_rc"])?>
        </div>
    </div>
</div>
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                <?=Html::dropDownList("cmb_modalidad_rc", 0, $arr_modalidad, ["class" => "form-control", "id" => "cmb_modalidad_rc"])?>
        </div>
    </div>
</div>
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                <?=Html::dropDownList("cmb_profesor_rc", 0, $arr_profesor_all, ["class" => "form-control", "id" => "cmb_profesor_rc"])?>
        </div>
    </div>
</div>
<div class='col-xs-12 col-sm-12 col-md-6 col-lg-6'>
