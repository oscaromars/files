...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="lbl_unidad" class="col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= Yii::t("formulario", "Academic unit"); ?></label>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">  
        ...
        <div class="col-sm-2">                
            <a id="btn_buscarRegistro" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Search") ?></a>
        </div>
    </div>
</div></br>
