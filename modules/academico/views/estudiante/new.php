    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                    <input type="text" class="form-control keyupmce" id="txt_matricula" disabled data-type="alfanumerico" data-keydown="true" placeholder="<?= academico::t("Academico", 'Enrollment Number') ?>">
                </div>
            </div>
        </div>
    </div>
