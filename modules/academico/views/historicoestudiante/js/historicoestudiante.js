...
$(document).ready(function () {
    $('#btn_buscarDatahistoest').click(function () {
       actualizarGrid();
    });
    ...
    $('#cmb_unidadbus').change(function () {
        var link = $('#txth_base').val() + "/academico/historicoestudiante/index";
    ...
    $('#cmb_unidad').change(function () {
        var link = $('#txth_base').val() + "/academico/historicoestudiante/new";
    ...
    $('#cmb_unidades').change(function () {
        var link = $('#txth_base').val() + "/academico/historicoestudiante/edit";
...
function actualizarGrid() {
    ...
    if (!$(".blockUI").length) {
        showLoadingPopup();
        $('#Pbg_Historialestudiante').PbGridView('applyFilterData', {'search': search, 'unidad': unidad, 'modalidad': modalidad, 'carrera': carrera});
...
function exportExcel() {
    ...
    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/expexcel?search=" + search ;
}

function exportPdf() {
    var search = $('#txt_buscarData').val();
    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/exppdf?pdf=1&search=" + search ;
}

function exportExcelEstudiante() {
    var search = $('#txt_buscarData').val();   
    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/expexcelestudiante?search=" + search ;
}

function exportPdfEstudiante() {
    var search = $('#txt_buscarData').val();   
    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/exppdfestudiante?pdf=1&search=" + search ;
}
function save() {
    var link = $('#txth_base').val() + "/academico/historicoestudiante/save";
    var arrParams = new Object();
...
function update() {
    var link = $('#txth_base').val() + "/academico/historicoestudiante/update";
    var arrParams = new Object();
...
function accion(id, estado) {
    var link = $('#txth_base').val() + "/academico/historicoestudiante/";
    var arrParams = new Object();
    arrParams.est_id = id;
    ...
    if (!validateForm()) {
        requestHttpAjax(link, arrParams, function (response) {
            ...
            if (!response.error) {
                setTimeout(function () {
                    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/index";
                }, 3000);
            }
        }, true);
    }
...
function edit() {
    ...
    window.location.href = $('#txth_base').val() + "/academico/historicoestudiante/edit?per_id=" + per_id + "&est_id=" + est_id;
}
