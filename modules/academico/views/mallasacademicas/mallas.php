...
<div class="row">
    ...
    <?php if(!empty($arr_codmalla["codmalla"])) {?>
       <img src="<?= Url::base(). '/site/getimage/?route=/uploads/malla/malla_'.$arr_codmalla["codmalla"].'.jpg' ?>" width="<?= $widthImg ?>px" height="<?= $heightImg ?>px" id='img_destino' <?php //class="img-circle" ?> alt="Malla Carrera" />
       <?php } else {?>
