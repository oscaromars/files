 ...
 <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <?= Html::dropDownList("cmb_periodo_new", 0, $arr_periodo, ["class" => "form-control", "id" => "cmb_periodo_new"]) ?>
                </div>
                 <label for="lbl_unidad" class="col-lg-2 col-md-2 col-sm-2 col-xs-2 control-label"><?= Yii::t("formulario", "Unidad"); ?></label>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <?= Html::dropDownList("cmb_unidad_new", 0, $arr_unidad, ["class" => "form-control", "id" => "cmb_unidad_new"]) ?>
                </div>      
            </div>
        </div>
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                    <?= Html::dropDownList("cmb_modalidad_new", 0, $arr_modalidad, ["class" => "form-control", "id" => "cmb_modalidad_new"]) ?>
                </div>            
            </div>
        ...
        <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
            ...
            <div class="col-sm-2 col-md-2 col-xs-4 col-lg-2">               
                <a id="btn_buscarDataNewAsignarMateriaParalelo" href="javascript:" class="btn btn-primary btn-block"> <?= Yii::t("formulario", "Search") ?></a>
            </div>
        </div>  
