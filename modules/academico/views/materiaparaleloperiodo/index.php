        ...
        [
            ...
            'buttons' => [
                ...
                'parallel' => function ($url, $model) {
                    if($model->mpp_num_paralelo <20){
                        return Html::a('<span class="glyphicon glyphicon-edit"></span>', Url::to(['updateschedule', 'id' => $model->mpp_id,'mod_id' => $model->mod_id,'asi_id' => $model->asi_id,'paca_id' => $model->paca_id]), ["data-toggle" => "tooltip", "title" => Yii::t("accion", "Modificar Horario")]);
                    }else{
                        return null;
                    }
                   },
