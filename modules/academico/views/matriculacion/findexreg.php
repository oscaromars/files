...
<a href="<?= Url::to(['/academico/matriculacion/registro', 'per_id' => $per_id]) ?>" class="btn btn-primary pull-right" style="margin: 0px 5px;"><?= Academico::t("matriculacion", "Continuar") ?></a>
