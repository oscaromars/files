...
Academico::registerTranslations();
 //print_r($howmuchSubject);


if ($isdrop) {
echo "<b style='color:green'>MATERIAS REGISTRADAS</b>";
} Else
...
<br>
<?=
    $this->render('registrosch-grid', ['planificacion' => $planificacion,'materiasxEstudiante' => $materiasxEstudiante, 'registredSuject' => $registredSuject, "cancelStatus" => $cancelStatus, "ron_id" => $ron_id, "isdrop" => $isdrop, ]);
?>
