...
?>
<a href="<?= Url::to(['/academico/registro/index']) ?>" class="btn btn-primary pull-right" style="margin: 0px 5px;"><?= Academico::t("matriculacion", "Go to Pay") ?></a>
<?php if($cancelStatus == '0'): ?>
<?php if(isset($anularRegistro) && $anularRegistro == true): ?>
...
<?php endif; ?>
<?php endif; ?>
<?php if(isset($hasSubject) && $hasSubject == true): ?>
    <a href="javascript:registerSubject()" class="btn btn-success pull-right" style="margin: 0px 5px;"><?= Academico::t("matriculacion", "Register More Subjects") ?></a>
<?php endif; ?>