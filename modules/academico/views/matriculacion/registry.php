...
<form class="form-horizontal">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h4><span><?= academico::t("matriculacion", "Student data") ?></span></h4>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                <label for="cmb_aprobar" class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label"><?= academico::t("matriculacion", 'Registration') ?></label>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <?= Html::dropDownList("cmb_aprobar", 0, $estadoAprobar, ["class" => "form-control", "id" => "cmb_aprobar",]) ?>  
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                <label for="txt_observacion" class="col-lg-6 col-md-6 col-sm-6 col-xs-6 control-label"><?= academico::t("registro", 'Observations') ?></label>
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <textarea class="form-control PBvalidation" id='txt_observacion' rows="3" placeholder="<?= academico::t("registro", 'Observations') ?>"></textarea>
                </div>
            </div>
        </div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4><span><?= academico::t("matriculacion", "Number Subjects") ?></span></h4>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
<?=
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <h4><span><?= academico::t("registro", "Total Payment") ?></span></h4>
</div>
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
