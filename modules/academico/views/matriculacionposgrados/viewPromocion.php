    ...
    <div class='col-md-12 col-sm-12 col-xs-12 col-lg-12'>        
        ...
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control PBvalidation" value="<?= $data_promo['ppro_grupo'] ?>" id="txt_grupo" data-type="alfanumerico" data-keydown="true" disabled = "true" placeholder="<?= Yii::t("academico", "Grupo") ?>">
                </div>
            </div>
        </div>                
    </div> 
