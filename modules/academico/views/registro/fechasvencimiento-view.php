    ...
    <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
            <div class="form-group">
                ...
                <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                    <div class="checkbox">
                        <label><input type="checkbox" id='cmb_req' <?= ($value_terminos==1)?('checked="checked"'):"";  ?> disabled="disabled" > <?= academico::t('registro', 'I accept the terms and conditions of the university regarding payments for subject registration.')?></label>
                    </div>
                </div>
            </div>
        </div>
...
<input type="hidden" id="lbl_payment" value="<?= financiero::t("Pagos", 'Payment #') ?>" />
