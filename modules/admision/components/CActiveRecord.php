...
class CActiveRecord extends \yii\db\ActiveRecord {
    ...
    {
        $connection = new \app\components\CConnection(Yii::$app->controller->module->db_crm);
        return $connection;
    ...
    {
        if(Yii::$app->controller->module->db_crm["dbname"]){
            $dbname = StringHelper::basename(Yii::$app->controller->module->db_crm["dbname"]);
