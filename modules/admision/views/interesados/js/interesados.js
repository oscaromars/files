...
function exportExcel() {
    ...
    var empresa = $('#cmb_empresa option:selected').val();
    var unidad = $('#cmb_unidad option:selected').val();
    window.location.href = $('#txth_base').val() + "/admision/interesados/expexcel?search=" + search + "&f_ini=" + f_ini + "&f_fin=" + f_fin + "&empresa=" + empresa + "&unidad=" + unidad;
...
function exportPdfAspirante(){
    ...
    var empresa = $('#cmb_empresa option:selected').val();
    var unidad = $('#cmb_unidad option:selected').val();
    window.location.href = $('#txth_base').val() + "/admision/interesados/exppdfaspirantes?pdf=1&search=" + search + "&f_ini=" + f_ini + "&f_fin=" + f_fin + "&empresa=" + empresa+ "&unidad=" + unidad;
}
