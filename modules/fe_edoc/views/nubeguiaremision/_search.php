...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'IdGuiaRemision'); ?>
		<?php echo $form->textField($model,'IdGuiaRemision',array('size'=>19,'maxlength'=>19)); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'FechaInicioTransporte'); ?>
		<?php echo $form->textField($model,'FechaInicioTransporte'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'FechaFinTransporte'); ?>
