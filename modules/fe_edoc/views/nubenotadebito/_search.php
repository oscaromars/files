...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'IdNotaDebito'); ?>
		<?php echo $form->textField($model,'IdNotaDebito',array('size'=>19,'maxlength'=>19)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'ValorTotal',array('size'=>19,'maxlength'=>19)); ?>
	</div>
