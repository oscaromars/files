...
<form class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control PBvalidation" id="frm_div" value="<?= $model->div_nombre ?>" data-type="all" placeholder="<?= financiero::t("divisa", "Name")  ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="frm_div_cod" class="col-sm-3 control-label"><?= financiero::t("divisa", "Code") ?></label>
        <div class="col-sm-9">
            <input type="text" maxlength="2" class="form-control PBvalidation" id="frm_div_cod" value="<?= $model->div_cod ?>" data-type="number" placeholder="<?= financiero::t("divisa", "Code") ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="frm_div_cot" class="col-sm-3 control-label"><?= financiero::t("divisa", "Price") ?></label>
        <div class="col-sm-9">
            <input type="text" class="form-control PBvalidation" id="frm_div_cot" value="<?= $model->div_cotizacion ?>" data-type="dinero" placeholder="<?= financiero::t("divisa", "Price") ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-1">
            <div class="input-group">
                ...
                <span id="spanDivStatus" class="input-group-addon input-group-addon-border-left input-group-addon-pointer"><i id="iconDivStatus" class="<?= ($model->div_estado == 1)?"glyphicon glyphicon-check":"glyphicon glyphicon-unchecked" ?>"></i></span>
            </div>
        </div>
    </div>
</form>
