...
<form class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control PBvalidation" id="frm_lven" value="<?= $model->lven_nombre ?>" data-type="all" placeholder="<?= financiero::t("linea_venta", "Name")  ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="frm_lven_cod" class="col-sm-3 control-label"><?= financiero::t("linea_venta", "Code") ?></label>
        <div class="col-sm-9">
            <input type="text" maxlength="2" class="form-control PBvalidation" id="frm_lven_cod" value="<?= $model->lven_cod ?>" data-type="number" placeholder="<?= financiero::t("linea_venta", "Code") ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-1">
            <div class="input-group">
                ...
                <span id="spanlvenStatus" class="input-group-addon input-group-addon-border-left input-group-addon-pointer"><i id="iconlvenStatus" class="<?= ($model->lven_estado == 1)?"glyphicon glyphicon-check":"glyphicon glyphicon-unchecked" ?>"></i></span>
            </div>
        </div>
    </div>
</form>
