...
<form class="form-horizontal">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control PBvalidation" id="frm_mart" value="<?= $model->mart_nombre ?>" data-type="all" placeholder="<?= financiero::t("marca_articulo", "Name")  ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="frm_mart_cod" class="col-sm-3 control-label"><?= financiero::t("marca_articulo", "Code") ?></label>
        <div class="col-sm-9">
            <input type="text" maxlength="2" class="form-control PBvalidation" id="frm_mart_cod" value="<?= $model->mart_cod ?>" data-type="number" placeholder="<?= financiero::t("marca_articulo", "Code") ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-1">
            <div class="input-group">
                ...
                <span id="spanmartStatus" class="input-group-addon input-group-addon-border-left input-group-addon-pointer"><i id="iconmartStatus" class="<?= ($model->mart_estado == 1)?"glyphicon glyphicon-check":"glyphicon glyphicon-unchecked" ?>"></i></span>
            </div>
        </div>
    </div>
</form>
