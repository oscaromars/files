...
CREATE TABLE IF NOT EXISTS `IG0020` (
  ...
  `COD_PAI` varchar(5) DEFAULT NULL,
  `COD_DIV` varchar(2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `MG0014` (
  `C_I_OCG` varchar(5) NOT NULL DEFAULT '',
  `COD_OCG` varchar(5) NOT NULL, -- 01 => Pais   02 => Provincia    03 => Ciudad
...
CREATE TABLE IF NOT EXISTS `TIPO_ITEM` (
  ...
  `TITE_PREFIX` VARCHAR(3) NOT NULL UNIQUE,
