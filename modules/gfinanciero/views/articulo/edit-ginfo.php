...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->UBI_FIS ?>" id="frm_ubicacion" data-type="all" placeholder="<?= financiero::t("articulo", "Location") ?>">
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <?=
                    DatePicker::widget([
                        ...
                        'options' => ["class" => "form-control PBvalidation", "id" => "frm_fexp", "data-type" => "fecha", "placeholder" => financiero::t("articulo", "Expires")],
                        'pluginOptions' => [
                            'autoclose' => true,
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <?= Html::dropDownList("cmb_tipo", $model->TIP_PRO, $arr_tipo, ["class" => "form-control", "id" => "cmb_tipo",]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->NUM_CRE ?>" id="frm_credit" data-type="number" placeholder="<?= financiero::t("articulo", "Credits") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="checkbox" id="chk_descon" value="" <?= ($model->I_M_DES == 1)?"checked='checked'":"" ?> /> <label for="chk_descon" class="control-label"><?= financiero::t("articulo", "Discontinued") ?></label>&nbsp;&nbsp;&nbsp;
                <input type="checkbox" id="chk_iva" value="" <?= ($model->I_M_IVA == 1)?"checked='checked'":"" ?> /> <label for="chk_iva" class="control-label"><?= financiero::t("articulo", "VAT Tax") ?></label>
            </div>
        </div>
    </div>
</div>
