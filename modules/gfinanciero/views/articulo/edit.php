...
<form class="form-horizontal">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->DES_COM ?>"  id="frm_name" data-type="all" placeholder="<?= financiero::t("articulo", "Article Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->DES_NAT ?>" id="frm_altname" data-type="all" placeholder="<?= financiero::t("articulo", "Alternative Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_2">
                            <?= $this->render('edit-prices', ['model' => $model,]); ?>
                        </div>
                        <div class="tab-pane" id="tab_3">
                            <?= $this->render('edit-stock', ['model' => $model,]); ?>
                        </div>
                        <div class="tab-pane" id="tab_4">
                            <?= $this->render('edit-observations', ['model' => $model,]); ?>
                        </div>
                    </div>
                </div>
            </div>
