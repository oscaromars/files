...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="" id="frm_ubicacion" data-type="all" placeholder="<?= financiero::t("articulo", "Location") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <input type="text" class="form-control PBvalidations" value="" id="frm_proveedordesc" data-type="all" disabled="disabled" />
            </div>
        </div>
    </div> 
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="0" id="frm_credit" data-type="number" placeholder="<?= financiero::t("articulo", "Credits") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="checkbox" id="chk_descon" value=""> <label for="chk_descon" class="control-label"><?= financiero::t("articulo", "Discontinued") ?></label>&nbsp;&nbsp;&nbsp;
                <input type="checkbox" id="chk_iva" value=""> <label for="chk_iva" class="control-label"><?= financiero::t("articulo", "VAT Tax") ?></label>
            </div>
        </div>
    </div>
</div>
