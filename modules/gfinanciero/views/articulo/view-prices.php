    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="input-group">
                    <span class="input-group-addon"><?= Yii::$app->params['currency'] ?></span>
                    <input type="text" class="form-control PBvalidation cval" value="<?= number_format($model->P_COSTO, Yii::$app->params['numDecimals'], '.', ',') ?>" disabled="disabled" id="frm_pref" data-type="all" />
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <?=
        ...
        <div class="form-group">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation cper" value="<?= number_format($model->POR_N01, 2, '.', ',') ?>" id="frm_pv1po" disabled="disabled" data-refid="frm_pv1pr" data-type="all" />
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="input-group">
                    ...
                    <span class="input-group-addon"><?= Yii::$app->params['currency'] ?></span>
                    <input type="text" class="form-control PBvalidation cval" value="<?= number_format($model->PAUX_03, Yii::$app->params['numDecimals'], '.', ',') ?>" id="frm_pv1pr" disabled="disabled" data-refid="frm_pv1po" data-type="all" />
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <label for="frm_pv1un" style="display: none;"><?= financiero::t("articulo", "P. V1") ?> </label>
                    <input type="text" class="form-control PBvalidation uval" value="<?= number_format($model->CANT_01, 0, '.', ',') ?>" id="frm_pv1un" disabled="disabled" data-type="all" />
        ...
        <div class="form-group">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation cper" value="<?= number_format($model->POR_N02, 2, '.', ',') ?>" id="frm_pv2po" disabled="disabled" data-refid="frm_pv2pr" data-type="all" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="input-group">
                    ...
                    <span class="input-group-addon"><?= Yii::$app->params['currency'] ?></span>
                    <input type="text" class="form-control PBvalidation cval" value="<?= number_format($model->P_VENTA, Yii::$app->params['numDecimals'], '.', ',') ?>" id="frm_pv2pr" disabled="disabled" data-refid="frm_pv2po" data-type="all" />
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <label for="frm_pv2un" style="display: none;"><?= financiero::t("articulo", "P. V2") ?> </label>
                    <input type="text" class="form-control PBvalidation uval" value="<?= number_format($model->CANT_02, 0, '.', ',') ?>" id="frm_pv2un" disabled="disabled" data-type="all" />
                    <span class="input-group-addon"><?= financiero::t("articulo", "Units") ?></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation cper" value="<?= number_format($model->POR_N03, 2, '.', ',') ?>" id="frm_pv3po" disabled="disabled" data-refid="frm_pv3pr" data-type="all" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="input-group">
                    ...
                    <span class="input-group-addon"><?= Yii::$app->params['currency'] ?></span>
                    <input type="text" class="form-control PBvalidation cval" value="<?= number_format($model->PAUX_01, Yii::$app->params['numDecimals'], '.', ',') ?>" id="frm_pv3pr" disabled="disabled" data-refid="frm_pv3po" data-type="all" />
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <label for="frm_pv3un" style="display: none;"><?= financiero::t("articulo", "P. V3") ?> </label>
                    <input type="text" class="form-control PBvalidation uval" value="<?= number_format($model->CANT_03, 0, '.', ',') ?>" id="frm_pv3un" disabled="disabled" data-type="all" />
                    <span class="input-group-addon"><?= financiero::t("articulo", "Units") ?></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation cper" value="<?= number_format($model->POR_N04, 2, '.', ',') ?>" id="frm_pv4po" disabled="disabled" data-refid="frm_pv4pr" data-type="all" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                <div class="input-group">
                    ...
                    <span class="input-group-addon"><?= Yii::$app->params['currency'] ?></span>
                    <input type="text" class="form-control PBvalidation cval" value="<?= number_format($model->PAUX_02, Yii::$app->params['numDecimals'], '.', ',') ?>" id="frm_pv4pr" disabled="disabled" data-refid="frm_pv4po" data-type="all" />
                </div>
            </div>
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <label for="frm_pv4un" style="display: none;"><?= financiero::t("articulo", "P. V4") ?> </label>
                    <input type="text" class="form-control PBvalidation uval" value="<?= number_format($model->CANT_04, 0, '.', ',') ?>" id="frm_pv4un" disabled="disabled" data-type="all" />
                    <span class="input-group-addon"><?= financiero::t("articulo", "Units") ?></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= number_format($model->POR_DES, 2, '.', ',') ?>" id="frm_descven" disabled="disabled" data-type="all" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
        </div>
