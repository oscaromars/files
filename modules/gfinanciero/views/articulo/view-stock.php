    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= number_format($model->EXI_MIN, 0, '.', ',') ?>" id="frm_min" disabled="disabled" data-type="number" />
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= number_format($model->EXI_MAX, 0, '.', ',') ?>" id="frm_max" disabled="disabled" data-type="number" />
            </div>
        </div>
    </div>
    <div class="col-md-6">
