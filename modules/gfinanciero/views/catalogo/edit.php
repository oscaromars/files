...
<form class="form-horizontal">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_CTA ?>" id="frm_name" data-type="all" placeholder="<?= financiero::t("lineaarticulo", "Name Account") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <?=
                        Html::dropDownList(
                                "cmb_tipcuenta", $model->TIP_CTA, array_merge([financiero::t("catalogo", "-- Select --")], $arrtipCuenta), ["class" => "form-control", "id" => "cmb_tipcuenta"]
                        )
                 ?>
            </div>
        </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <?=
                        Html::dropDownList(
                                "cmb_tipregistro", $model->TIP_REG, array_merge([financiero::t("catalogo", "-- Select --")], $arrtipRegistro), ["class" => "form-control", "id" => "cmb_tipregistro"]
                        )
                 ?>
            </div>
        </div>
