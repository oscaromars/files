...
<form class="form-horizontal">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_DIV ?>" id="frm_nombre" data-type="alfa" disabled="disabled" placeholder="<?= financiero::t("divisa", "Name") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->V_COTIZ ?>" id="frm_cotizacion" data-type="all" disabled="disabled" placeholder="<?= financiero::t("divisa", "Quotation") ?>">
            </div>
        </div>
    </div>
</form>
