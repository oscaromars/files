    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="" id="frm_bul" disabled="disabled" data-type="all" placeholder="<?= financiero::t("egresomercaderia", "Bulk Boxes") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="" id="frm_recibido" disabled="disabled" data-type="all" placeholder="<?= financiero::t("egresomercaderia", "Received By") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="" id="frm_revisado" disabled="disabled" data-type="all" placeholder="<?= financiero::t("egresomercaderia", "Reviewed By") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="" id="frm_kardex" disabled="disabled" data-type="all" placeholder="<?= financiero::t("egresomercaderia", "Annotated Kardex") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <textarea class="form-control PBvalidation" id="txta_obse" data-type="all" disabled="disabled" placeholder="<?= financiero::t("egresomercaderia", "Observations") ?>"></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidations" value="0" id="frm_tart" data-type="all" disabled="disabled" placeholder="<?= financiero::t("egresomercaderia", "Article Types") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidations" value="0" id="frm_citem" data-type="all" disabled="disabled" placeholder="<?= financiero::t("egresomercaderia", "Items Amount") ?>">
            </div>
        </div>
