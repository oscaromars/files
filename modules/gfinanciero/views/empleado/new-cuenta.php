    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_grupo", 0, $arr_grupo, ["class" => "form-control", "id" => "cmb_grupo"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_rol", 0, $arr_rol, ["class" => "form-control", "id" => "cmb_rol"]) ?>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_username" data-type="all" placeholder="<?= financiero::t("empleado", "Username") ?>">
            </div>
        </div>
        <div class="form-group">
