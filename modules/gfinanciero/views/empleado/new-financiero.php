    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_banco", 0, $arr_banco, ["class" => "form-control", "id" => "cmb_banco"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_cc_banco" data-type="all" placeholder="<?= financiero::t("empleado", "Bank Account Number") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tpago", 0, $tipo_pago, ["class" => "form-control", "id" => "cmb_tpago"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                <input type="text" class="form-control PBvalidations" value="<?= $cuenta_name ?>" id="frm_accdesc" data-type="all" disabled="disabled" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_cod_vend" data-type="all" data-lengthMax="3" placeholder="<?= financiero::t("empleado", "Vendor Code") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="file-upload-wrapper form-control" data-text="<?= Yii::t('accion', 'LoadFile') ?>" data-textbtn="<?= Yii::t('jslang', 'Upload') ?>">
                    <input type="file" class="PBvalidation file-upload-field" value="" name="frm_ced_foto"  id="frm_ced_foto" data-type="all" placeholder="<?= financiero::t("empleado", "DNI Picture") ?>">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="file-upload-wrapper form-control" data-text="<?= Yii::t('accion', 'LoadFile') ?>" data-textbtn="<?= Yii::t('jslang', 'Upload') ?>">
                    <input type="file" class="PBvalidation file-upload-field" value="" name="frm_contr_file"  id="frm_contr_file" data-type="all" placeholder="<?= financiero::t("empleado", "Agreement PDF") ?>">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="file-upload-wrapper form-control" data-text="<?= Yii::t('accion', 'LoadFile') ?>" data-textbtn="<?= Yii::t('jslang', 'Upload') ?>">
                    <input type="file" class="PBvalidation file-upload-field" value="" name="frm_entr_file"  id="frm_entr_file" data-type="all" placeholder="<?= financiero::t("empleado", "Admission PDF") ?>">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_departamento", 0, $arr_departamento, ["class" => "form-control", "id" => "cmb_departamento"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_subdepartamento", 0, $arr_subdepartamento, ["class" => "form-control", "id" => "cmb_subdepartamento"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tipContrato", 0, $arr_tipoContrato, ["class" => "form-control", "id" => "cmb_tipContrato"]) ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_cargo", 0, $arr_cargo, ["class" => "form-control", "id" => "cmb_cargo"]) ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_freserva" value="0" placeholder="<?= financiero::t("empleado", "Reserve Assets") ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_dtercero" value="0" placeholder="<?= financiero::t("empleado", "Thirteenth Salary") ?>">
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus"><i class="iconAccStatus glyphicon glyphicon-unchecked"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_dcuarto" value="0" placeholder="<?= financiero::t("empleado", "Fourteenth Salary") ?>">
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus"><i class="iconAccStatus glyphicon glyphicon-unchecked"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_sobretiempo" value="0" placeholder="<?= financiero::t("empleado", "Overtime") ?>">
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus"><i class="iconAccStatus glyphicon glyphicon-unchecked"></i></span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_t_empleado", 0, $arr_t_empleado, ["class" => "form-control", "id" => "cmb_t_empleado"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tipContribuyente", 0, $arr_tipoContribuyente, ["class" => "form-control", "id" => "cmb_tipContribuyente"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="0" id="frm_cargas" data-type="number" placeholder="<?= financiero::t("empleado", "Family Responsibilities") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_discapacidad" value="0" placeholder="<?= financiero::t("empleado", "Discapacity") ?>">
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus frm_disc"><i class="iconAccStatus glyphicon glyphicon-unchecked"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group csdiscp" style="display: none;">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("frm_tip_disc", 0, $arr_discapacidad, ["class" => "form-control", "id" => "frm_tip_disc"]) ?>
            </div>
        </div>
        <div class="form-group csdiscp" style="display: none;">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="0" id="frm_per_disc" data-type="number" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
        </div>
