    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_pri_nombre" data-type="all" placeholder="<?= Yii::t("formulario", "First Name") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_seg_nombre" data-type="all" placeholder="<?= Yii::t("formulario", "Middle Name") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_pri_apellido" data-type="all" placeholder="<?= Yii::t("formulario", "Last Name2") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_seg_apellido" data-type="all" placeholder="<?= Yii::t("formulario", "Last Second Name1") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_ecivil", 0, $arr_civil, ["class" => "form-control", "id" => "cmb_ecivil"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div class="col-sm-12 text-center">
                    <div class="file-upload-wrapper form-control" data-text="<?= Yii::t('accion', 'LoadFile') ?>" data-textbtn="<?= Yii::t('jslang', 'Upload') ?>">
                        <input type="file" class="PBvalidation file-upload-field" value="" name="txth_foto"  id="txth_foto" data-type="all" placeholder="<?= Yii::t('jslang', 'Upload') ?>">
                    </div>
                </div>
                <div class="col-sm-12">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_correo" data-type="email" placeholder="<?= Yii::t("formulario", "Email") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_celular" data-type="all" placeholder="<?= Yii::t("formulario", "CellPhone") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_telefono" data-type="all" placeholder="<?= Yii::t("formulario", "Phone") ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="frm_telefonoc" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label"><?= Yii::t("formulario", "Phone Company") ?> </label>
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidations" value="" id="frm_telefonoc" data-type="all" placeholder="<?= Yii::t("formulario", "Phone Company") ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="frm_extension" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label"><?= Yii::t("formulario", "Extension") ?> </label>
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidations" value="" id="frm_extension" data-type="all" placeholder="<?= Yii::t("formulario", "Extension") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tipo_sangre", 0, $tipos_sangre, ["class" => "form-control", "id" => "cmb_tipo_sangre"]) ?>
            </div>
        </div>
        <div class="form-group">
            <label for="cmb_raza_etnica" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label"><?= Yii::t("formulario", "Ethnic") ?> </label>
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_raza_etnica", 0, $etnica, ["class" => "form-control", "id" => "cmb_raza_etnica"]) ?>
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_cedula" data-type="all" placeholder="<?= Yii::t("formulario", "DNI Document") ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="frm_ruc" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label"><?= Yii::t("formulario", "RUC") ?> </label>
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidations" value="" id="frm_ruc" data-type="all" placeholder="<?= Yii::t("formulario", "RUC") ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="frm_pasaporte" class="col-xs-4 col-sm-4 col-md-4 col-lg-4 control-label"><?= Yii::t("formulario", "Passport") ?> </label>
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidations" value="" id="frm_pasaporte" data-type="all" placeholder="<?= Yii::t("formulario", "Passport") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="" id="frm_nacionalidad" data-type="all" placeholder="<?= Yii::t("formulario", "Nationality") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_pai_nac", $pai_id, $arr_pais_nac, ["class" => "form-control", "id" => "cmb_pai_nac"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_pro_nac", 0, $arr_prov_nac, ["class" => "form-control", "id" => "cmb_pro_nac"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_ciu_nac", 0, $arr_ciu_nac, ["class" => "form-control", "id" => "cmb_ciu_nac"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    <input type="hidden" class="form-control PBvalidation" id="frm_ecua" value="1" placeholder="<?= financiero::t("empleado", "Ecuadorian") ?>">
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus"><i class="iconAccStatus glyphicon glyphicon-check"></i></span>
                </div>
            </div>
        </div>
    </div>
