    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_banco", $model->empl_ids_ban, $arr_banco, ["class" => "form-control", "id" => "cmb_banco", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="<?= $model->empl_cuenta_bancaria ?>" disabled="disabled" id="frm_cc_banco" data-type="all" placeholder="<?= financiero::t("empleado", "Bank Account Number") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tpago", $model->empl_metodo_pago, $tipo_pago, ["class" => "form-control", "id" => "cmb_tpago", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <?=
                DatePicker::widget([
                    ...
                    'options' => ["class" => "form-control PBvalidation", "id" => "frm_ingreso", "data-type" => "fecha", "placeholder" => financiero::t("empleado", "Date of Admission"), "disabled" => "disabled"],
                    'pluginOptions' => [
                        'autoclose' => true,
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="<?= $model->empl_cod_vendedor ?>" disabled="disabled" id="frm_cod_vend" data-type="all" data-lengthMax="3" placeholder="<?= financiero::t("empleado", "Vendor Code") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::a(financiero::t('empleado', 'Download File'), Url::to(['/'.Yii::$app->controller->module->id.'/empleado/view', 'download' => true, 'code' => $model->empl_codigo, "tipo" => 'ced']), ['class' => 'form-control']) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::a(financiero::t('empleado', 'Download File'), Url::to(['/'.Yii::$app->controller->module->id.'/empleado/view', 'download' => true, 'code' => $model->empl_codigo, "tipo" => 'con']), ['class' => 'form-control']) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::a(financiero::t('empleado', 'Download File'), Url::to(['/'.Yii::$app->controller->module->id.'/empleado/view', 'download' => true, 'code' => $model->empl_codigo, "tipo" => 'avi']), ['class' => 'form-control']) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_departamento", $dep_id, $arr_departamento, ["class" => "form-control", "id" => "cmb_departamento", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_subdepartamento", $sdep_id, $arr_subdepartamento, ["class" => "form-control", "id" => "cmb_subdepartamento", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tipContrato", $model->tipc_id, $arr_tipoContrato, ["class" => "form-control", "id" => "cmb_tipContrato", "disabled" => "disabled"]) ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_cargo", $cargo, $arr_cargo, ["class" => "form-control", "id" => "cmb_cargo", "disabled" => "disabled", ]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control PBvalidation" value="<?= $salario ?>" disabled="disabled" id="frm_salario" data-type="all" placeholder="<?= financiero::t("cargo", "Salary") ?>">
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <?=
                DatePicker::widget([
                    ...
                    'type' => DatePicker::TYPE_INPUT,
                    'options' => ["class" => "form-control PBvalidation", "id" => "frm_fecha_ssocial", "data-type" => "fecha", "placeholder" => financiero::t("empleado", "Social Security Date"), "disabled" => "disabled"],
                    'pluginOptions' => [
                        'autoclose' => true,
                        'format' => Yii::$app->params["dateByDatePicker"],
                    ]]
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss"><i class="iconAccStatus glyphicon glyphicon-<?= ($model->empl_fondo_reserva == "1")?"check":"unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss"><i class="iconAccStatus glyphicon glyphicon-<?= ($model->empl_decimo_tercero == "1")?"check":"unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss"><i class="iconAccStatus glyphicon glyphicon-<?= ($model->empl_decimo_cuarto == "1")?"check":"unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss"><i class="iconAccStatus glyphicon glyphicon-<?= ($model->empl_paga_sobretiempo == "1")?"check":"unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_t_empleado", $model->tipe_id, $arr_t_empleado, ["class" => "form-control", "id" => "cmb_t_empleado", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("cmb_tipContribuyente", $model->tcon_id, $arr_tipoContribuyente, ["class" => "form-control", "id" => "cmb_tipContribuyente", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <input type="text" class="form-control PBvalidation" value="<?= $model->empl_carga_familiar ?>" disabled="disabled" id="frm_cargas" data-type="number" placeholder="<?= financiero::t("empleado", "Family Responsibilities") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss frm_disc"><i class="iconAccStatus glyphicon glyphicon-<?= (isset($model->dis_id) && $model->dis_id != "")?"check":"unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
        <div class="form-group csdiscp" style="<?= (isset($model->dis_id) && $model->dis_id != "")?"":"display: none;" ?>">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <?= Html::dropDownList("frm_tip_disc", (isset($model->dis_id) && $model->dis_id != "")?$model->dis_id:0, $arr_discapacidad, ["class" => "form-control", "id" => "frm_tip_disc", "disabled" => "disabled"]) ?>
            </div>
        </div>
        <div class="form-group csdiscp" style="<?= (isset($model->dis_id) && $model->dis_id != "")?"":"display: none;" ?>">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" disabled="disabled" value="<?= (isset($model->empl_porcentaje_discapacidad) && $model->empl_porcentaje_discapacidad != "")?$model->empl_porcentaje_discapacidad:0 ?>" id="frm_per_disc" data-type="number" />
                    <span class="input-group-addon">%</span>
                </div>
            </div>
        </div>
