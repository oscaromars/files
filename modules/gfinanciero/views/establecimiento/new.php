...
<form class="form-horizontal">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="" id="frm_codigo" data-type="all" data-lengthMin="3" data-lengthMax="3" placeholder="<?= financiero::t("establecimiento", "Code") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="" id="frm_nombre" data-type="all" placeholder="<?= financiero::t("establecimiento", "Name") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="" id="frm_correoct" data-type="mail" placeholder="<?= financiero::t("establecimiento", "Mail") ?>"> 
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="cmb_provincia" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label"><?= financiero::t("localidad", "State") ?> <span class="text-danger">*</span></label>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="cmb_ciudad" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label"><?= financiero::t("localidad", "City") ?> <span class="text-danger">*</span></label>
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="" id="frm_direccion" data-type="all" placeholder="<?= financiero::t("establecimiento", "Address") ?>"> 
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="" id="frm_telefono1" data-type="all" placeholder="<?= financiero::t("establecimiento", "Telephone 1") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidations" value="" id="frm_telefono2" data-type="all" placeholder="<?= financiero::t("establecimiento", "Telephone 2") ?>"> 
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidations" value="" id="frm_telefonofax" data-type="all" placeholder="<?= financiero::t("establecimiento", "Telephone Fax") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
