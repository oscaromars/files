...
<div>
    <div class="tleft" style="width: 50%;">
        <fieldset class="fsets tborder">
            ...
            <span class="tbold"><?= $arr_head['lblbodSec']?>: </span><span><?= $model->NUM_ING ?></span><br/>
            <br/>
            <br/>
            <br/>
        </fieldset>
...
<br />
<div>
    <div class="tleft" style="width: 50%"><span class="tbold"><?= $arr_head['lblCliPro'] ?>: </span><span><?= $model->NOM_PRO ?></span><br/></div>
    ...
    <tfoot>
        ...
        <tr>
            ...
            <td class="talign-right outPad">
                <span class="tbold"><?= $arr_head['lblTotal'] ?>: </span><?= number_format($model->T_I_ING, 2, '.', ',') ?>
            </td>
        </tr>
