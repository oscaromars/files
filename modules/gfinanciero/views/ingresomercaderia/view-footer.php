    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="<?= $model->LIN_N02 ?>" id="frm_bul" disabled="disabled" data-type="all" placeholder="<?= financiero::t("ingresomercaderia", "Bulk Boxes") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="<?= $model->LIN_N03 ?>" id="frm_recibido" disabled="disabled" data-type="all" placeholder="<?= financiero::t("ingresomercaderia", "Received By") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="<?= $model->LIN_N04 ?>" id="frm_revisado" disabled="disabled" data-type="all" placeholder="<?= financiero::t("ingresomercaderia", "Reviewed By") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidation" value="<?= $model->LIN_N05 ?>" id="frm_kardex" disabled="disabled" data-type="all" placeholder="<?= financiero::t("ingresomercaderia", "Annotated Kardex") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <textarea class="form-control PBvalidation" id="txta_obse" data-type="all" disabled="disabled" placeholder="<?= financiero::t("ingresomercaderia", "Observations") ?>"><?= $model->LIN_N01 ?></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidations" value="<?= $model->T_P_ING ?>" id="frm_tart" data-type="all" disabled="disabled" placeholder="<?= financiero::t("ingresomercaderia", "Article Types") ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                <input type="text" class="form-control PBvalidations" value="<?= $model->T_I_ING ?>" id="frm_citem" data-type="all" disabled="disabled" placeholder="<?= financiero::t("ingresomercaderia", "Items Amount") ?>">
            </div>
        </div>
