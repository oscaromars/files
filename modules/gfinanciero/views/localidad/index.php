...
<div class="row">
    <form class="form-horizontal">
        ...
        <div class="col-md-12 col-xs-12 col-lg-12 col-sm-12">
            <div class="form-group">
                <label for="cmb_tipo" class="col-sm-2 col-sm-2 col-lg-2 col-md-2 col-xs-2 control-label"><?= financiero::t("localidad", "Location Type") ?></label>
...
<br />
<?=
    $this->render('index-grid', ['model' => $model, 'codes' => $codes, ]);
?>