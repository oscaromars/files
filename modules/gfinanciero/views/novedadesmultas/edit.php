...
<form class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control PBvalidation" value="<?= number_format($model->nmul_valor, 2, '.', ',') ?>" id="frm_valor" data-type="all" placeholder="<?= financiero::t("novedadesmultas", "Value") ?>">
                </div>
            </div>
        </div>
    </div>  
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <textarea class="form-control PBvalidations" rows="4" id="frm_observacion" data-type="all" placeholder="<?= financiero::t("novedadesmultas", "Observation") ?>"><?= $model->nmul_observacion ?></textarea>
            </div>
        </div>
    </div>  
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <?= Html::dropDownList("cmb_status", $model->nmul_estado_cancelado, $arr_estados, ["class" => "form-control cmst", "id" => "cmb_status"]) ?>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 ccEst" style="<?=  (($model->nmul_estado_cancelado == "1")?"":"display: none;") ?>">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <?= Html::dropDownList("cmb_autoriza", $autoriza, $arr_Empleados, ["class" => "form-control", "id" => "cmb_autoriza"]) ?>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 ccEst" style="<?=  (($model->nmul_estado_cancelado == "1")?"":"display: none;") ?>">
        <div class="form-group">
            ...
            <?=
                DatePicker::widget([
                    ...
                    'options' => ["class" => "form-control " . (($model->nmul_estado_cancelado == "1")?"PBvalidation":"PBvalidations"), "id" => "frm_fpago", "data-type" => "fecha", "placeholder" => financiero::t("novedadesmultas", "Payment Date"),],
                    'pluginOptions' => [
                        'autoclose' => true,
