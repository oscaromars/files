        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <?= Html::dropDownList("cmb_tipo_est", $model->COD_PTO, $arr_establecimiento, ["class" => "form-control", "id" => "cmb_tipo_est", "disabled" => "disabled",]) ?>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->COD_CAJ ?>" disabled="disabled" id="frm_codigo" data-type="all" data-lengthMin="3" data-lengthMax="3" placeholder="<?= financiero::t("puntoemision", "Code") ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_CAJ ?>" id="frm_nombre" data-type="all" placeholder="<?= financiero::t("puntoemision", "Name") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class ="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->UBI_CAJ ?>" id="frm_ubicacion" data-type="all" placeholder="<?= financiero::t("puntoemision", "Location") ?>"> 
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <div class="input-group">
                        ...
                        <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatus"><i class="iconAccStatus glyphicon glyphicon glyphicon-<?= ($model->AUT_CAJ == '1') ? "check" : "unchecked" ?>"></i></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->COD_RES ?>" id="frm_responsable" data-type="all" placeholder="<?= financiero::t("puntoemision", "Responsable") ?>"> 
                </div>
            </div>
        </div>
