...
<form class="form-horizontal">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->CONTADOR ?>" id="frm_contador" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocomprobante", "Accountant") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_TIP ?>" id="frm_nombre" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocomprobante", "Name") ?>">
            </div>
        </div>
    </div> 
</form>
