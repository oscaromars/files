...
<form class="form-horizontal">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->COD_CON ?>"id="frm_codigo" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocontribuyente", "Code") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_CON ?>"id="frm_nombre" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocontribuyente", "Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->POR_R_F ?>" id="frm_porrf" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocontribuyente", "% Ret. RFE") ?>">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->POR_R_I ?>" id="frm_porri" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocontribuyente", "% Ret. Vat") ?>">
                    <span class="input-group-addon">%</span>
                </div> 
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span class="input-group-addon input-group-addon-border-left input-group-addon-pointer spanAccStatuss"><i class="iconAccStatus glyphicon glyphicon glyphicon-<?= ($model->GRA_IVA == '1') ? "check" : "unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
    </div>  
