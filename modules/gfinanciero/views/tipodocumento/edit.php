    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->NUM_NOF ?>" id="frm_numdocumento" data-type="all" placeholder="<?= financiero::t("tipodocumento", "Document Number") ?>">  
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->NOM_NOF ?>" id="frm_nombredocumento" data-type="all"  placeholder="<?= financiero::t("tipodocumento", "Document Name") ?>">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                    ...
                    SearchAutocomplete::widget([
                        ...
                        'defaultValue' => $model->CTA_IVA,
                        'htmlOptions' => ['class' => 'PBvalidations'],
                    ]);
                    ?>
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <input type="text" class="form-control PBvalidations" value="<?= $ctaiva ?>" id="frm_ctaivadesc" data-type="all" disabled="disabled" />
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->POR_IVA ?>" id="frm_iva" data-type="all" placeholder="<?= financiero::t("tipodocumento", "Vat %") ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <?= Html::dropDownList("cmb_tipo_trans", $tip_trans, $arr_tipo_trans, ["class" => "form-control", "id" => "cmb_tipo_trans",]) ?> 
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class ="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <?= Html::dropDownList("cmb_tipo_edoc", ($modelTipEdoc->IdDirectorio != "")?($modelTipEdoc->IdDirectorio):"0", $arr_tipo_edoc, ["class" => "form-control", "id" => "cmb_tipo_edoc",]) ?> 
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->C_ITEMS ?>" id="frm_cantitems" data-type="number" placeholder="<?= financiero::t("tipodocumento", "Quantity Items") ?>">  
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                    <?= Html::dropDownList("cmb_tipo_sec", $model->SEC_AUT, $arr_tipo_sec, ["class" => "form-control", "id" => "cmb_tipo_sec",]) ?> 
                </div>
            </div>
        </div>
    </div>
