    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->tipe_nombre ?>" id="frm_nombre" data-type="all" disabled="disabled" placeholder="<?= financiero::t("tipocomprobante", "Name") ?>">
            </div>
        </div>
    </div> 
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                ...
                DatePicker::widget([
                    'name' => 'frm_fecha',
                    'value' => date(Yii::$app->params["dateByDefault"], strtotime($model->tipe_fecha_creacion)),
...
<input type="hidden" id="frm_id" value="<?= $model->tipe_id ?>">