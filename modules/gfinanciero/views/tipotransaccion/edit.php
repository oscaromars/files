...
<form class="form-horizontal">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
                <input type="text" class="form-control PBvalidation" value="<?= $model->N_TRA_E ?>" id="frm_name" data-type="all" placeholder="<?= financiero::t("tipotransaccion", "Transaction Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-xs-7 col-sm-8 col-md-9 col-lg-10">
            <?= Html::dropDownList("cmb_tipo", $model->T_TRA_E, $arr_tipo, ["class" => "form-control", "id" => "cmb_tipo", ]) ?> 
            </div>
        </div>
    </div> 
</form>
