<?php
namespace app\modules\gpr;

use Yii;

class Module extends \yii\base\Module
{
    public $db_gpr;    // se debe colocar el identificador de la base que se define en el archivo de modulos: mod.php
    public $class;  // se debe colocar el la clase de la conexion de la base que se define en el archivo de modulos: mod.php
    public $controllerNamespace = 'app\modules\gpr\controllers';
    private static $module_name = 'gpr';
