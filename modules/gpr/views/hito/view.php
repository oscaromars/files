...
<form class="form-horizontal">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->hito_nombre?>" disabled="disabled" id="frm_name" data-type="all" placeholder="<?= gpr::t("hito", "Milestone Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->hito_descripcion ?>" disabled="disabled" id="frm_desc" data-type="all" placeholder="<?= gpr::t("hito", "Milestone Description") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->hito_peso ?>" disabled="disabled" id="frm_peso" data-type="number" placeholder="<?= gpr::t("hito", "Weighing") ?>">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= round($model->hito_presupuesto, 2) ?>" disabled="disabled" id="frm_presupuesto" data-type="number" placeholder="<?= gpr::t("hito", "Budget") ?>">
                    <span class="input-group-addon">$</span>
                </div>
            </div>
        </div>
