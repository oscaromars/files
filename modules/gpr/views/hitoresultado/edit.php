...
<form class="form-horizontal">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?=
                    DatePicker::widget([
                        ...
                        'type' => DatePicker::TYPE_INPUT,
                        'options' => ["class" => "form-control PBvalidation", "id" => "frm_freal", "data-type" => "fecha", "placeholder" => gpr::t("hito", "Actual Date")],
                        'pluginOptions' => [
                            'autoclose' => true,
                            'format' => Yii::$app->params["dateByDatePicker"],
                        ]]
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= round($model->hseg_presupuesto, 2) ?>" id="frm_gasto" data-type="number" placeholder="<?= gpr::t("hito", "Current Cost") ?>">
                    <span class="input-group-addon">$</span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->hseg_progreso ?>" id="frm_avance" data-type="number" placeholder="<?= gpr::t("hito", "Progress") ?>">
                    <span class="input-group-addon">%</span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_obj", $modelHito->hito_cumplido, $arr_cumplimiento, ["class" => "form-control", "id" => "cmb_cumplido", ]) ?>  
            </div>
        </div>
    </div> 
</form>
