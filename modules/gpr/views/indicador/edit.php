...
<form class="form-horizontal">
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->ind_nombre ?>" id="frm_name" data-type="all" placeholder="<?= gpr::t("indicador", "Indicator Name") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->ind_linea_base ?>" id="frm_baseline" data-type="all" placeholder="<?= gpr::t("indicador", "Base Line Initial") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_objoperativo", $model->oope_id, $arr_obj_operativo, ["class" => "form-control", "id" => "cmb_objoperativo", ]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_medida", $model->umed_id, $arr_unidad_medida, ["class" => "form-control", "id" => "cmb_medida",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->ind_fuente_informe ?>" id="frm_fuente" data-type="all" placeholder="<?= gpr::t("indicador", "Source File") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->ind_metodo_calculo ?>" id="frm_calculo" data-type="all" placeholder="<?= gpr::t("indicador", "Calculation Method") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_jerarquia", $model->jind_id, $arr_jerarquia, ["class" => "form-control", "id" => "cmb_jerarquia",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_tconfiguracion", $model->tcon_id, $arr_tconf, ["class" => "form-control", "id" => "cmb_tconfiguracion",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_patron", $model->pind_id, $arr_patron, ["class" => "form-control", "id" => "cmb_patron",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <textarea class="form-control PBvalidation" id="frm_desc" rows="5" data-type="all" placeholder="<?= gpr::t("indicador", "Indicator Description") ?>"><?= $model->ind_descripcion ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_compartamiento", $model->cind_id, $arr_comportamiento, ["class" => "form-control", "id" => "cmb_compartamiento",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_tmeta", $model->tmet_id, $arr_tmeta, ["class" => "form-control", "id" => "cmb_tmeta",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_frecuencia", $model->find_id, $arr_frecuencia, ["class" => "form-control", "id" => "cmb_frecuencia",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_fraccional", $model->ind_fraccional, $arr_fraccional, ["class" => "form-control", "id" => "cmb_fraccional",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_agrupacion", $model->ind_agrupamiento, $arr_agrupacion, ["class" => "form-control", "id" => "cmb_agrupacion",]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
        <div class="form-group" id="dvTagr" data-agrp="0" style="display: none;">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_tagrupacion", $model->tagr_id, $arr_tagrupacion, ["class" => "form-control", "id" => "cmb_tagrupacion",]) ?>  
            </div>
        </div>
    </div> 
</form>
