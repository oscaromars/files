...
$buttons = [
    'edit' => function ($url, $model) {
        if($model['MetaCerrada'] == 0)
            return Html::a('<span class="'.Utilities::getIcon('edit').'"></span>', 'javascript:editMeta('.$model['id'].', "'.gpr::t('meta', $model['Periodo']).'", true)', ["data-toggle" => "tooltip", "title" => Yii::t("accion","Edit")]);
