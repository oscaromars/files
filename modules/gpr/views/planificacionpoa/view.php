...
<form class="form-horizontal">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?=  $model->ppoa_nombre ?>" id="frm_name" disabled="disabled" data-type="all" placeholder="<?= gpr::t("planificacionpoa", "Poa Planning Name") ?>">
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <textarea id="frm_desc" class="form-control PBvalidation" rows="5" disabled="disabled" data-type="alfa" placeholder="<?= gpr::t("planificacionpoa", "Poa Planning Description") ?>"><?=  $model->ppoa_descripcion ?></textarea>        
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_plan", $model->pped_id, $arr_plan, ["class" => "form-control", "id" => "cmb_plan", "disabled" => "disabled"]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?=
                    DatePicker::widget([
                        ...
                        'options' => ["class" => "form-control PBvalidation", "id" => "frm_fini", "disabled" => "disabled", "data-type" => "fecha", "placeholder" => gpr::t("planificacionpoa", "Poa Planning Initial Date")],
                        'pluginOptions' => [
                            'autoclose' => true,
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?=
                    DatePicker::widget([
                        ...
                        'type' => DatePicker::TYPE_INPUT,
                        'options' => ["class" => "form-control PBvalidation", "id" => "frm_fend", "disabled" => "disabled","data-type" => "fecha", "placeholder" => gpr::t("planificacionpoa", "Poa Planning Initial Date")],
                        'pluginOptions' => [
                            'autoclose' => true,
                            'format' => Yii::$app->params["dateByDatePicker"],
                        ]]
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_cierre", $model->ppoa_estado_cierre, $arr_cierre, ["class" => "form-control", "id" => "cmb_cierre", "disabled" => "disabled"]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <div class="input-group">
                    ...
                    <span id="spanAccStatuss" class="input-group-addon input-group-addon-border-left input-group-addon-pointer"><i id="iconAccStatuss" class="<?= ($model->ppoa_estado == 1)?"glyphicon glyphicon-check":"glyphicon glyphicon-unchecked" ?>"></i></span>
                </div>
            </div>
        </div>
    </div> 
