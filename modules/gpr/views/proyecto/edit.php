...
<form class="form-horizontal">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <input type="text" class="form-control PBvalidation" value="<?= $model->pro_nombre ?>" id="frm_name" data-type="all" placeholder="<?= gpr::t("proyecto", "Project Name") ?>">
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <textarea class="form-control PBvalidation" id="frm_desc" data-type="all" placeholder="<?= gpr::t("proyecto", "Project Description") ?>"><?= $model->pro_descripcion ?></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_tipo", $model->tpro_id, $arr_tippro, ["class" => "form-control", "id" => "cmb_tipo"]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_objop", $model->oope_id, $arr_objope, ["class" => "form-control", "id" => "cmb_objop"]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <?= Html::dropDownList("cmb_ugpr", $model->ugpr_id, $arr_unidad, ["class" => "form-control", "id" => "cmb_ugpr"]) ?>  
            </div>
        </div>
    </div> 
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <div class="input-group">
                    <input type="text" class="form-control PBvalidation" value="<?= $model->pro_presupuesto ?>" id="frm_presupuesto" data-type="number" placeholder="<?= gpr::t("hito", "Budget") ?>">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            ...
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <textarea class="form-control PBvalidation" id="frm_restricciones" data-type="all" placeholder="<?= gpr::t("proyecto", "Restrictions") ?>"><?= $model->pro_restricciones ?></textarea>
            </div>
        </div>
    </div>
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
        <div class="form-group">
            <label for="frm_razon" class="col-sm-5 col-md-5 col-xs-5 col-lg-5 control-label"><?= gpr::t("proyecto", 'Reason Change') ?> <span class="text-danger">*</span></label>
            <div class="col-sm-7 col-md-7 col-xs-7 col-lg-7">
                <textarea class="form-control PBvalidation" id="frm_razon" data-type="all" placeholder="<?= gpr::t("proyecto", "Reason Change") ?>"><?= $model->pro_razon_cambio ?></textarea>
            </div>
        </div>
    </div>
</form>
