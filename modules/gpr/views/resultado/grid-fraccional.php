...
$buttons = [
    'edit' => function ($url, $model) {
        if($model['PeriodoCerrado'] == 0)
            return Html::a('<span class="'.Utilities::getIcon('edit').'"></span>', 'javascript:editResultado('.$model['id'].', "'.gpr::t('meta', $model['Periodo']).'", true)', ["data-toggle" => "tooltip", "title" => Yii::t("accion","Edit")]);
