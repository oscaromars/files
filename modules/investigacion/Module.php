<?php
namespace app\modules\investigacion;

use Yii;

class Module extends \yii\base\Module
{
    public $db_investigacion;    // se debe colocar el identificador de la base que se define en el archivo de modulos: mod.php
    public $class;  // se debe colocar el la clase de la conexion de la base que se define en el archivo de modulos: mod.php
    public $controllerNamespace = 'app\modules\investigacion\controllers';
    private static $module_name = 'investigacion';
