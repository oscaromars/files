...
return [
    "Project" => "Proyecto",
    "Administration - Type of Project" => "Administración - Tipo de Proyecto",
    "Register of Project" => "Registo de Proyecto",
    "Information - Project Director" => "Información - Director de Proyecto",
    "Information - Director of Research" => "Información - Director de Investigaciones",
    "Information - Project Registration" => "Información - Registro de Proyecto",
    "Educational Entity" => "Entidad Educativa",
    "Type de Project" => "Tipo de Proyecto",
    "Must be Fill all information in fields with label *." => "Debe completar toda la información en los campos con etiqueta *.",
    "Name" => "Nombre",
    "Surname" => "Apellido",
    "Identification card" => "Cédula",
    "Execution area" => "Área de Ejecución",
    "Nationality" => "Nacionalidad",
    "Mail" => "Correo",
    "CellPhone" => "Celular",
    "Area Manager" => "Jefe de Área",
    "Address" => "Dirección",
    "Province" => "Provincia",
    "Canton" => "Cantón",
    "Regional Zone" => "Zona Regional",
    "Region" => "Región",  
    "Project Title" => "Título de Proyecto",
    "Summary" => "Resumen",
    "Registration of Members" => "Registro de Integrantes",
    "Role" => "Rol",
    "Responsible" => "Responsable",
    "Information - Members" => "Información - Integrantes",
