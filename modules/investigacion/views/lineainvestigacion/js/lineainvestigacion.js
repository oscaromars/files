...
function editReg() {
    var link = $('#txth_base').val() + "/investigacion/lineainvestigacion/edit/" + $("#frm_linv_id").val();
    window.location = link;
}

function updateReg() {
    var link = $('#txth_base').val() + "/investigacion/lineainvestigacion/edit/updatereg";
    var arrParams = new Object();
...
function saveReg() {
    var link = $('#txth_base').val() + "/investigacion/lineainvestigacion/savereg";
    var arrParams = new Object();
    arrParams.nombre_investigacion = $('#txt_nameline').val();
