...
<form class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control PBvalidation " value="<?= $model->mpro_descripcion ?>" id="txt_nameline" data-type="all" data-keydown="true"  placeholder="<?= investigacion::t("macroproyecto", 'Macroproject') ?>"> 
