<?php
namespace app\modules\marcacionhistorico;

use Yii;

class Module extends \yii\base\Module
{
    public $db_marcacion_historico;    // se debe colocar el identificador de la base que se define en el archivo de modulos: mod.php
    public $class;  // se debe colocar el la clase de la conexion de la base que se define en el archivo de modulos: mod.php
    public $controllerNamespace = 'app\modules\marcacionhistorico\controllers';
    private static $module_name = 'db_marcacion_historico';
