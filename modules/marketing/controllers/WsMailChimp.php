...
class WsMailChimp
{
    ...
    {
        $this->apiKey  = "2a2dbbb8a33adbb41b46fb0efbb46fc4-us20";// produccion; "4d6064da3ab51d18e0586027f4cdbda9-us19"; //ambiente desarrollo 
        $this->user = "Uteg";
    ...
    public function newList($nameList, $from_name, $from_email, $subject, $contact, $lang = "es"){
        ...
        $arr_response = json_decode($response, true);
        \app\models\Utilities::putMessageLogFile("response:".$response);   
        return $arr_response;
    }
