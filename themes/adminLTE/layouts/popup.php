...
if ($isUser) {
    ...
    <html lang="<?= Yii::$app->language ?>">
        ...
        <body class="hold-transition skin-blue body-system body-popup">
            <?php $this->beginBody() ?>
            <div class="wrapper">
                <!-- Content Wrapper. Contains page content -->
                <?= $this->render('wrapper-popup.php', ['directoryAsset' => $directoryAsset, 'content' => $content]) ?>
                
                <!-- Main Footer -->
                <?= $this->render('footer.php',['directoryAsset' => $directoryAsset, 'footerClass' => 'main-footer popup-footer']) ?>
            </div>
            <!-- Modal -->
