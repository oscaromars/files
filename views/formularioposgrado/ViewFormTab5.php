...
<form class="form-horizontal">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            <label for="cmb_tipo_discapView" class="col-lg-3 col-md-3 col-xs-3 col-sm-3 control-label"><?= Yii::t("inscripcionposgrado", "Tipo de Discapcidad") ?></label>
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
                <?= Html::dropDownList("cmb_tipo_discapView", $discapacidad_model->tdis_id, $arr_tip_discap, ["class" => "form-control", "id" => "cmb_tipo_discapView" , "disabled" => "disabled"]) ?>
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
                <input type="text" class="form-control PBvalidation keyupmce" id="txt_porc_discapacidadView" value="<?= $discapacidad_model->ides_porcentaje ?>" data-type="alfanumerico" disabled="disabled" data-keydown="true" placeholder="<?= Yii::t("bienestar", "Percentage Disability") ?>">
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
