...
$(document).ready(function () {
    ...
    /*$('#txt_cedula').change(function () {
        ...
        var link = $('#txth_base').val() + "/inscripciongrado/index";
        var arrParams = new Object();
        arrParams.persona = $('#txt_cedula').val();
        if ($('#txt_cedula').val() != 0) {

            $('#Divdatospersona').show();
            
        } else if ($('#txt_cedula').val() == 0)
        {
...
function guardarInscripcionGrado() {
    var ID = /*(accion == "UpdateDepTrans") ?*/ $('#txth_igra_id').val()/* : 0*/;
    var link = $('#txth_base').val() + "/inscripciongrado/guardarinscripciongrado";
    var arrParams = new Object();
    arrParams.DATA_1 = dataInscripcion();
...
function dataInscripcion(ID) {
    ...
    objDat.igra_ruta_doc_record = ($('#txth_doc_recordacad').val() != '') ? $('#txth_doc_recordacad').val() : '';
...
function buscarpersona(per_cedula){
