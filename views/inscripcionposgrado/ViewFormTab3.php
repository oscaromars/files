    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
                <input type="text" class="form-control PBvalidation" id="frm_per_trabajo_direccion" value="<?= $persona_model->per_trabajo_direccion ?>" data-type="all" disabled="disabled" placeholder="<?= Yii::t("inscripcionposgrado", "Dirección de Trabajo")  ?>">
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group">
            ...
            <div class="col-lg-9 col-md-9 col-xs-9 col-sm-9">
                <input type="text" class="form-control PBvalidation" id="frm_contc_emergencias" value="<?= $contacto_model->pcon_nombre ?>" data-type="all" disabled="disabled" placeholder="<?= Yii::t("inscripcionposgrado", "Nombre de Contacto en caso de Emergencia")  ?>">
            </div>
        </div>
    </div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
