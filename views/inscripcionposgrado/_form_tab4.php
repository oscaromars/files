...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 doc_foto cinteres">
    <div class="form-group">
        ...
        return {"upload_file": true, "name_file": "doc_foto", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            echo CFileInputAjax::widget([
                ...
                'pluginOptions' => [
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_dni", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            echo CFileInputAjax::widget([
                ...
                'pluginOptions' => [
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_certvota", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            echo CFileInputAjax::widget([
                ...
                'pluginOptions' => [
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_titulo", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12"> 
    <div class="form-group">
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            <?php
            echo CFileInputAjax::widget([
                'id' => 'txth_doc_comprobante',
                'name' => 'txth_doc_comprobante',
                'pluginLoading' => false,
                'showMessage' => false,
                'pluginOptions' => [
                    'showPreview' => false,
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_comprobante", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_comprobante').val($('#txth_doc_comprobante').val());
    $('#txth_doc_comprobante').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 doc_record1 cinteres"> 
    <div class="form-group">
        ...
        return {"upload_file": true, "name_file": "doc_comprobante", "inscripciongrado_id": $("#txth_igra_id").val()};
                ...
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_record1').val($('#txth_doc_record1').val());
    $('#txth_doc_record1').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12"> 
    <div class="form-group">
        ...
        return {"upload_file": true, "name_file": "doc_comprobante", "inscripciongrado_id": $("#txth_igra_id").val()};
                ...
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_senecyt').val($('#txth_doc_senecyt').val());
    $('#txth_doc_senecyt').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            echo CFileInputAjax::widget([
                ...
                'pluginOptions' => [
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_hojavida", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            echo CFileInputAjax::widget([
                ...
                'pluginOptions' => [
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_aceptacion", "inscripgrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 doc_cartarecomendacion cinteres"> 
    <div class="form-group">
        <label for="txth_doc_cartarecomendacion" class="col-sm-2 col-md-2 col-xs-2 col-lg-2 control-label keyupmce"><?= Yii::t("formulario", "Récor Académico Actualizado") ?></label>
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            <?= Html::hiddenInput('txth_doc_cartarecomendacion', '', ['id' => 'txth_doc_cartarecomendacion']); ?>
            <?php
            echo CFileInputAjax::widget([
                'id' => 'txth_doc_cartarecomendacion',
                'name' => 'txth_doc_cartarecomendacion',
                'pluginLoading' => false,
                'showMessage' => false,
                'pluginOptions' => [
                    'showPreview' => false,
        ...
        return {"upload_file": true, "name_file": "doc_comprobante", "inscripciongrado_id": $("#txth_igra_id").val()};
                ...
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_cartarecomendacion').val($('#txth_doc_cartarecomendacion').val());
    $('#txth_doc_cartarecomendacion').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12"> 
    <div class="form-group">
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            <?php
            echo CFileInputAjax::widget([
                'id' => 'txth_doc_certificadolaboral',
                'name' => 'txth_doc_certificadolaboral',
                'pluginLoading' => false,
                'showMessage' => false,
                'pluginOptions' => [
                    'showPreview' => false,
        ...
        return {"upload_file": true, "name_file": "doc_comprobante", "inscripciongrado_id": $("#txth_igra_id").val()};
                ...
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_certificadolaboral').val($('#txth_doc_certificadolaboral').val());
    $('#txth_doc_certificadolaboral').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
...
<div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 doc_certificadoingles cinteres"> 
    <div class="form-group">
        ...
        <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
            ...
            <?php
            echo CFileInputAjax::widget([
                'id' => 'txth_doc_certificadoingles',
                'name' => 'txth_doc_certificadoingles',
                'pluginLoading' => false,
                'showMessage' => false,
                'pluginOptions' => [
                    'showPreview' => false,
                    ...
                    'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                    'uploadExtraData' => 'javascript:function (previewId,index) {
        return {"upload_file": true, "name_file": "doc_certificadoingles", "inscripciongrado_id": $("#txth_igra_id").val()};
    }',
                ],
                'pluginEvents' => [
                    "filebatchselected" => "function (event) {
    $('#txth_doc_certificadoingles').val($('#txth_doc_certificadoingles').val());
    $('#txth_doc_certificadoingles').fileinput('upload');
}",
                    "fileuploaderror" => "function (event, data, msg) {
    $(this).parent().parent().children().first().addClass('hide');
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
                    ...
                    <?php
                    echo CFileInputAjax::widget([
                        'id' => 'txth_doc_recordacad',
                        'name' => 'txth_doc_recordacad',
                        'pluginLoading' => false,
                        'showMessage' => false,
                        'pluginOptions' => [
                            'showPreview' => false,
                            ...
                            'maxFileSize' => Yii::$app->params["MaxFileSize"], // en Kbytes
                            'uploadExtraData' => 'javascript:function (previewId,index) {
                return {"upload_file": true, "name_file": "doc_recordacad", "inscripgrado_id": $("#txth_igra_id").val()};
            }',
                        ],
                        'pluginEvents' => [
                            "filebatchselected" => "function (event) {
            $('#txth_doc_recordacad').val($('#txth_doc_recordacad').val());
            $('#txth_doc_recordacad').fileinput('upload');
        }",
                            "fileuploaderror" => "function (event, data, msg) {
            $(this).parent().parent().children().first().addClass('hide');
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
                    ...
                    <?php
                    echo CFileInputAjax::widget([
                        'id' => 'txth_doc_nosancion',
                        'name' => 'txth_doc_nosancion',
                        'pluginLoading' => false,
                        'showMessage' => false,
                        'pluginOptions' => [
                            'showPreview' => false,
                ...
                return {"upload_file": true, "name_file": "doc_recordacad", "inscripgrado_id": $("#txth_igra_id").val()};
                        ...
                        'pluginEvents' => [
                            "filebatchselected" => "function (event) {
            $('#txth_doc_nosancion').val($('#txth_doc_nosancion').val());
            $('#txth_doc_nosancion').fileinput('upload');
        }",
                            "fileuploaderror" => "function (event, data, msg) {
            $(this).parent().parent().children().first().addClass('hide');
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
                    ...
                    <?php
                    echo CFileInputAjax::widget([
                        'id' => 'txth_doc_syllabus',
                        'name' => 'txth_doc_syllabus',
                        'pluginLoading' => false,
                        'showMessage' => false,
                        'pluginOptions' => [
                            'showPreview' => false,
                ...
                return {"upload_file": true, "name_file": "doc_recordacad", "inscripgrado_id": $("#txth_igra_id").val()};
                        ...
                        'pluginEvents' => [
                            "filebatchselected" => "function (event) {
            $('#txth_doc_syllabus').val($('#txth_doc_syllabus').val());
            $('#txth_doc_syllabus').fileinput('upload');
        }",
                            "fileuploaderror" => "function (event, data, msg) {
            $(this).parent().parent().children().first().addClass('hide');
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">   
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6 col-xs-6 col-lg-6">
                    ...
                    <?php
                    echo CFileInputAjax::widget([
                        'id' => 'txth_doc_especievalorada',
                        'name' => 'txth_doc_especievalorada',
                        'pluginLoading' => false,
                        'showMessage' => false,
                        'pluginOptions' => [
                            'showPreview' => false,
                ...
                return {"upload_file": true, "name_file": "doc_recordacad", "inscripgrado_id": $("#txth_igra_id").val()};
                        ...
                        'pluginEvents' => [
                            "filebatchselected" => "function (event) {
            $('#txth_doc_especievalorada').val($('#txth_doc_especievalorada').val());
            $('#txth_doc_especievalorada').fileinput('upload');
        }",
                            "fileuploaderror" => "function (event, data, msg) {
            $(this).parent().parent().children().first().addClass('hide');
