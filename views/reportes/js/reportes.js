...
function exportExcelmatriculadospormateria() {
    ...
    window.location.href = $('#txth_base').val() + "/reportes/expexcelmatriculadospormateria?periodo=" + periodo + "&modalidad=" + modalidad + "&asignatura=" + asignatura;
}
